...
<DIV class='aside_menu'>
  <ASIDE style='float: left;'><A href='../category4/list.jsp'>게시판</A>＞<A href='./list_category_grid1.jsp?categoryno=<%=categoryno %>&category_title=<%=category_title %>'><%=category_title %></A>> 수정 ＞ 지도(Map) 수정 </ASIDE> 
  ...
  <DIV class='message'>
    ...
    if (pds4Proc.passwordCheck(pdsno, passwd) == 1) { // 패스워드 일치
      ...
      count = pds4Proc.replace_map(pds4VO);
      if (count == 1) { 
      %>
