...
<FORM name='frm' method='POST' action='./passwd_proc.jsp'
  ...
  <fieldset class='fieldset_no_line'>
    <ul>
      <li class='li_none'>
        <span style='width: 200px; text-align: right; background-color: #AAAAFF;'><label for='passwd'>기존 패스워드</label></span>
        <input type='password' name='passwd' id='passwd' required="required">
      </li>
      <li class='li_none'>
        <label for='new_passwd' style='width: 200px; text-align: right; background-color: #AAAAFF;'>새로운 패스워드</label>
